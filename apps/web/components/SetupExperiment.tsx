    ...
    <section className="band" id="start">
      <div className="wrap">
        ...
        <p className="sec-lead">
          ...
          already wired up, then write your first experiment — a folder with a
          task and a rubric. Every run is fully instrumented — traces, artifacts,
          diffs, and cost — captured automatically, with zero changes to the
          agent.
        </p>
        ...
        <div className="setupstep">
          ...
          <div
            className="cmdlist"
            dangerouslySetInnerHTML={{ __html: installCommands }}
          />
          <p className="cmdnote">
            Node 22+ and Docker — run <span className="mono">bn doctor</span> to
            verify your environment. <span className="mono">claude-code</span>,{" "}
            <span className="mono">codex-cli</span>, and{" "}
            <span className="mono">gemini-cli</span> ship ready; bringing your own
            agent is ~10 lines of YAML — start from a bundled one, or run{" "}
            <span className="mono">bn skills install</span> and let your agent
            write it. See the <a href="/docs">docs</a>.
          </p>
        </div>
        ...
        <div className="setupstep">
          ...
          <div className="stepc wide first">
            <div className="hd">
              ...
              <p>
                An <span className="mono" style={fg}>experiment.yaml</span>,
                optional verifier scripts your rubric calls, and a workspace
                seeded into the container. That&apos;s the whole thing.
              </p>
              {/* Static, build-time, author-controlled markup — see components/code-blocks.ts */}
              <div
                className="tree"
                dangerouslySetInnerHTML={{ __html: fileTree }}
              />
            </div>
          ...
          <p className="cmdnote">
            ...
            <span className="mono">browser-agent</span>. For the full range of
            agentic scorers, see{" "}
