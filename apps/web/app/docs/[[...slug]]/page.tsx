...
export async function generateMetadata({ params }: { params: Promise<Params> }): Promise<Metadata> {
  ...
  if (!s) {
    return {
      title: "Docs — Bunsen",
      description: "Documentation for Bunsen, an open-source research lab for agentic systems.",
    };
  }
  const doc = getDoc(s);
  if (!doc) return {};
  return {
    ...
    description: `${doc.meta.title} — documentation for Bunsen, an open-source research lab for agentic systems.`,
  };
}
